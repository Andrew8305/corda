...
object TxKeyFlow {
    ...
    class Provider(val otherSide: Party,
        ...
        override fun call(): CertPath {
            ...
            val selfSignedCertificate = X509Utilities.createSelfSignedCACert(ourParty.name)
            val ourCertificate = X509Utilities.createServerCert(ourParty.name, ourPublicKey,
            ...
            serviceHub.identityService.registerPath(selfSignedCertificate.certificate,
            ...
            send(otherSide, Pair(selfSignedCertificate.certificate, ourCertPath))
            return ourCertPath
        }
    }
